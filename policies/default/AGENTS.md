...
- **Adopt-or-Reject (2026-09-26):** Every recommendation/requirement is adopted (shipped + wired into default use, cite adopted-at) or rejected (recorded rule). Never close a parent with open sub-issues; `adoption_audit.py` enforces (AdoptOrRejectRule, PR #262).
