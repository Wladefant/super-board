...
- **Risk-Based Review & Focused Verification:**
  ...
  - **CI Time Bounds & Local Gates:** Never wait more than 5 minutes on CI; if CI is still running or queued after 5 minutes, proceed using local verification gates (tsc, lint, targeted tests). A **FAILED** check strictly blocks integration until resolved.
