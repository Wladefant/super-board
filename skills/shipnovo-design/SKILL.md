...
Work lives on the board: Shipnovo https://github.com/users/Wladefant/projects/11 -- linked to `Wladefant/shipnovo`. IDs in [BOARD-IDS](https://github.com/Wladefant/super-board/blob/main/docs/reference/BOARD-IDS.md).
