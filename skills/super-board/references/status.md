...
> **Source of truth: this file.** It used to be spec §7.5 in
> `docs/superpowers/specs/2026-05-21-super-board-design.md`, which is missing
> from this fork. See `SKILL.md` for what that changes.
>
